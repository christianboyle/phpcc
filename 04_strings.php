...
$string = "Hello, I am Christian"; // Extract TheCodeholic into variable
$string2 = 'Hello, I am Christian'; // Replace TheCodeholic with variable
echo $string . '<br>';
echo $string2 . '<br>';
...
$longText = "
  Hello, my name is <b>Christian</b>
  I am <b>27</b>,
  I love my daughter
";
echo "1 - " . $longText . '<br>';
